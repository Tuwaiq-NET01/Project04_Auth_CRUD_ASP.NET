...
{
    public partial class AddOneToOneMoveisTvsAndProfile : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { "2021-05-14", "https://image.tmdb.org/t/p/w300/w6n1pu9thpCVHILejsuhKf3tNCV.jpg", "Before he built a drug empire, Ferry Bouman returns to his hometown on a revenge mission that finds his loyalty tested — and a love that alters his life.", "Ferry" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 9,
                columns: new[] { "Date", "Poster", "Summary", "Title" },
                values: new object[] { "2021-05-27", "https://image.tmdb.org/t/p/w300/ccsSqbpEqr2KK9eMvoeF8ERFCd5.jpg", "Jack Halsey takes his wife, their adult kids, and a friend for a dream vacation in Kenya. But as they venture off alone into a wilderness park, their safari van is flipped over by an angry rhino, leaving them injured and desperate. Then, as two of them go in search of rescue, a bloody, vicious encounter with a leopard and a clan of hyenas incites a desperate fight for survival.", "Endangered Species" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 43,
                columns: new[] { "Date", "Poster", "Summary", "Title" },
                values: new object[] { "2013-03-20", "https://image.tmdb.org/t/p/w300/wVYREutTvI2tmxr6ujrHT704wGF.jpg", "Paranormal investigators Ed and Lorraine Warren work to help a family terrorized by a dark presence in their farmhouse. Forced to confront a powerful entity, the Warrens find themselves caught in the most terrifying case of their lives.", "The Conjuring" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 46,
                columns: new[] { "Date", "Poster", "Summary", "Title" },
                values: new object[] { "2019-12-19", "https://image.tmdb.org/t/p/w300/arHW8z3uHVknHc24dvc1pQvxjw.jpg", "A group of unlikely heroes from across the Korean peninsula try to save the day after a volcano erupts on the mythical and majestic Baekdu Mountain.", "Ashfall" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                column: "Poster",
                value: "https://image.tmdb.org/t/p/w300/kEl2t3OhXc3Zb9FBh1AuYzRTgZp.jpg");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 6,
                columns: new[] { "Date", "Poster", "Rating", "Summary", "Title" },
                values: new object[] { "2021-03-19", "https://image.tmdb.org/t/p/w300/6kbAMLteGO8yyewYau6bJ683sw7.jpg", 8, "Following the events of “Avengers: Endgame”, the Falcon, Sam Wilson and the Winter Soldier, Bucky Barnes team up in a global adventure that tests their abilities, and their patience.", "The Falcon and the Winter Soldier" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 15,
                columns: new[] { "Date", "Poster", "Summary", "Title" },
                values: new object[] { "2021-03-26", "https://image.tmdb.org/t/p/w300/yDWJYRAwMNKbIYT8ZB33qy84uzO.jpg", "Mark Grayson is a normal teenager except for the fact that his father is the most powerful superhero on the planet. Shortly after his seventeenth birthday, Mark begins to develop powers of his own and enters into his father’s tutelage.", "Invincible" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 20,
                columns: new[] { "Date", "Poster", "Rating", "Summary", "Title" },
                values: new object[] { "2017-04-26", "https://image.tmdb.org/t/p/w300/oIkxqt6ug5zT5ZSUUyc1Iqopf02.jpg", 8, "Set in a dystopian future, a woman is forced to live as a concubine under a fundamentalist theocratic dictatorship. A TV adaptation of Margaret Atwood's novel.", "The Handmaid's Tale" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 36,
                columns: new[] { "Date", "Poster", "Rating", "Summary", "Title" },
                values: new object[] { "2001-10-16", "https://image.tmdb.org/t/p/w300/pUhJGETy2sec4vEkiqJ9eGeIywc.jpg", 8, "The origins of the world’s greatest hero–from Krypton refugee Kal-el’s arrival on Earth through his tumultuous teen years to Clark Kent’s final steps toward embracing his destiny as the Man of Steel.", "Smallville" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 40,
                columns: new[] { "Date", "Poster", "Summary", "Title" },
                values: new object[] { "2013-09-12", "https://image.tmdb.org/t/p/w300/6PX0r5TRRU5y0jZ70y1OtbLYmoD.jpg", "A gangster family epic set in 1919 Birmingham, England and centered on a gang who sew razor blades in the peaks of their caps, and their fierce boss Tommy Shelby, who means to move up in the world.", "Peaky Blinders" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 46,
                columns: new[] { "Date", "Poster", "Rating", "Summary", "Title" },
                values: new object[] { "2005-09-13", "https://image.tmdb.org/t/p/w300/KoYWXbnYuS3b0GyQPkbuexlVK9.jpg", 8, "When they were boys, Sam and Dean Winchester lost their mother to a mysterious and demonic supernatural force. Subsequently, their father raised them to be soldiers. He taught them about the paranormal evil that lives in the dark corners and on the back roads of America ... and he taught them how to kill it. Now, the Winchester brothers crisscross the country in their '67 Chevy Impala, battling every kind of supernatural threat they encounter along the way. ", "Supernatural" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 53,
                columns: new[] { "Date", "Poster", "Summary", "Title" },
                values: new object[] { "2021-06-17", "https://image.tmdb.org/t/p/w300/ytfejoFQ9Ay3Z8MtYStJdXBvmrM.jpg", "Samuel attempts a big, romantic gesture at the airport in order to persuade Carla not to board her flight to London.", "Elite Short Stories: Carla Samuel" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 75,
                columns: new[] { "Date", "Poster", "Summary", "Title" },
                values: new object[] { "2011-10-05", "https://image.tmdb.org/t/p/w300/laAAPqhZ2dQuTZokuratKQ5EomT.jpg", "An anthology horror drama series centering on different characters and locations, including a house with a murderous past, an asylum, a witch coven, a freak show, a hotel, a farmhouse in Roanoke and a cult.", "American Horror Story" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 80,
                columns: new[] { "Date", "Poster", "Rating", "Summary", "Title" },
                values: new object[] { "2018-10-03", "https://image.tmdb.org/t/p/w300/A8NqOX6Tol9srq9pS740q2ktgzH.jpg", 7, "Isabel and Diego, two complete strangers, must assume the identity of a married couple in order to flee the state of Sonora.", "Falsa Identidad" });

            migrationBuilder.CreateIndex(
                name: "IX_TvShows_ProfileId",
                table: "TvShows",
                column: "ProfileId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_TvShows_Profiles_ProfileId",
                table: "TvShows",
                column: "ProfileId",
                principalTable: "Profiles",
                principalColumn: "Id",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 11,
                columns: new[] { "Date", "Poster", "Summary", "Title" },
                values: new object[] { "2021-05-05", "https://image.tmdb.org/t/p/w300/xCEg6KowNISWvMh8GvPSxtdf9TO.jpg", "A young boy finds himself pursued by two assassins in the Montana wilderness with a survival expert determined to protecting him - and a forest fire threatening to consume them all.", "Those Who Wish Me Dead" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 33,
                columns: new[] { "Date", "Poster", "Rating", "Summary", "Title" },
                values: new object[] { "2021-02-11", "https://image.tmdb.org/t/p/w300/zAWaWUsVSMhZJmMVYj3WzwprQN7.jpg", 8, "While under the care of the Outer Sailor Guardians, Hotaru begins to age rapidly. Then, the time comes for all the Sailor Guardians to reunite!", "Pretty Guardian Sailor Moon Eternal The Movie Part 2" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 40,
                columns: new[] { "Date", "Poster", "Rating", "Summary", "Title" },
                values: new object[] { "2021-05-04", "https://image.tmdb.org/t/p/w300/2xnf2ZaGXudvgBKPtVXMkNeooh1.jpg", 7, "In a daycare far, far away… but still in Springfield, Maggie is on an epic quest for her stolen pacifier. Her adventure brings her face-to-face with young Padawans, Sith Lords, familiar droids, Rebel scum, and an ultimate battle against the dark side, in this original short celebrating the Star Wars galaxy.", "Maggie Simpson in The Force Awakens from Its Nap" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 41,
                columns: new[] { "Date", "Poster", "Rating", "Summary", "Title" },
                values: new object[] { "2021-06-17", "https://image.tmdb.org/t/p/w300/7rhzEufovmmUqVjcbzMHTBQ2SCG.jpg", 8, "In a beautiful seaside town on the Italian Riviera, two young boys experience an unforgettable summer filled with gelato, pasta and endless scooter rides. But all the fun is threatened by a deeply-held secret: they are sea monsters from another world just below the water’s surface.", "Luca" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 43,
                columns: new[] { "Date", "Poster", "Summary", "Title" },
                values: new object[] { "2020-12-25", "https://image.tmdb.org/t/p/w300/hm58Jw4Lw8OIeECIq5qyPYhAeRJ.jpg", "Joe Gardner is a middle school teacher with a love for jazz music. After a successful gig at the Half Note Club, he suddenly gets into an accident that separates his soul from his body and is transported to the You Seminar, a center in which souls develop and gain passions before being transported to a newborn child. Joe must enlist help from the other souls-in-training, like 22, a soul who has spent eons in the You Seminar, in order to get back to Earth.", "Soul" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 46,
                columns: new[] { "Date", "Poster", "Summary", "Title" },
                values: new object[] { "2021-05-26", "https://image.tmdb.org/t/p/w300/vdMsMYfkHJ6mLht5QCg7Hl8hnEp.jpg", "After witnessing a haunting in their hospital, two doctors become dangerously obsessed with obtaining scientific proof that ghosts exist.", "Ghost Lab" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 69,
                columns: new[] { "Date", "Poster", "Summary", "Title" },
                values: new object[] { "2021-04-08", "https://image.tmdb.org/t/p/w300/vX1XLbrHxpryX9EOWI3akbasz6c.jpg", "Su, a woman whose friends are only men, finds herself forced to follow a series of absurd instructions to overcome the unexpected death of her fiancé.", "Instructions for Su" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 75,
                columns: new[] { "Date", "Poster", "Rating", "Summary", "Title" },
                values: new object[] { "2021-03-18", "https://image.tmdb.org/t/p/w300/4ZSzEDVdxWVMVO4oZDvoodQOEfr.jpg", 7, "The Secret Magic Control Agency sends its two best agents, Hansel and Gretel, to fight against the witch of the Gingerbread House.", "Secret Magic Control Agency" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 77,
                columns: new[] { "Date", "Poster", "Rating", "Summary", "Title" },
                values: new object[] { "2021-01-26", "https://image.tmdb.org/t/p/w300/4U1SBHmwHkNA0eHZ2n1CuiC1K1g.jpg", 6, "Jen and a group of friends set out to hike the Appalachian Trail. Despite warnings to stick to the trail, the hikers stray off course—and cross into land inhabited by The Foundation, a hidden community of mountain dwellers who use deadly means to protect their way of life.", "Wrong Turn" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 78,
                columns: new[] { "Date", "Poster", "Rating", "Summary", "Title" },
                values: new object[] { "2021-04-03", "https://image.tmdb.org/t/p/w300/tmghT8HaddVIS9hEXIOI9GuDchi.jpg", 5, "A group of archaeology students awaken an ancient mummy. After being trapped in a time loop, the only way they can escape, is to defeat the mummy. As the body count rises, it seems the Mummy has to collect the souls of those who woke him to be able to walk the earth - for good.", "Rise of the Mummy" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                column: "Poster",
                value: "https://image.tmdb.org/t/p/w300/rX1wQMTKFqF0gvZyS0DDQqgnQPB.jpg");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 5,
                columns: new[] { "Date", "Poster", "Rating", "Summary", "Title" },
                values: new object[] { "2020-01-31", "https://image.tmdb.org/t/p/w300/xUtOM1QO4r8w8yeE00QvBdq58N5.jpg", 8, "A small Norwegian town experiencing warm winters and violent downpours seems to be headed for another Ragnarök -- unless someone intervenes in time.", "Ragnarok" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 21,
                columns: new[] { "Date", "Poster", "Summary", "Title" },
                values: new object[] { "2018-10-25", "https://image.tmdb.org/t/p/w300/qTZIgXrBKURBK1KrsT7fe3qwtl9.jpg", "In a place where young witches, vampires, and werewolves are nurtured to be their best selves in spite of their worst impulses, Klaus Mikaelson’s daughter, 17-year-old Hope Mikaelson, Alaric Saltzman’s twins, Lizzie and Josie Saltzman, among others, come of age into heroes and villains at The Salvatore School for the Young and Gifted.", "Legacies" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 35,
                columns: new[] { "Date", "Poster", "Rating", "Summary", "Title" },
                values: new object[] { "2019-03-15", "https://image.tmdb.org/t/p/w300/asDqvkE66EegtKJJXIRhBJPxscr.jpg", 8, "Terrifying creatures, wicked surprises and dark comedy converge in this NSFW anthology of animated stories presented by Tim Miller and David Fincher.", "Love, Death & Robots" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 39,
                columns: new[] { "Date", "Poster", "Rating", "Summary", "Title" },
                values: new object[] { "2018-05-02", "https://image.tmdb.org/t/p/w300/4CkQvdUAtoLW3qkjWi7t1MTnW7R.jpg", 8, "This Karate Kid sequel series picks up 30 years after the events of the 1984 All Valley Karate Tournament and finds Johnny Lawrence on the hunt for redemption by reopening the infamous Cobra Kai karate dojo. This reignites his old rivalry with the successful Daniel LaRusso, who has been working to maintain the balance in his life without mentor Mr. Miyagi.", "Cobra Kai" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 40,
                columns: new[] { "Date", "Poster", "Summary", "Title" },
                values: new object[] { "2011-06-05", "https://image.tmdb.org/t/p/w300/vY2vfAskJTiWsQSv6bdbNCQhPLm.jpg", "Scott McCall, a high school student living in the town of Beacon Hills has his life drastically changed when he's bitten by a werewolf, becoming one himself. He must henceforth learn to balance his problematic new identity with his day-to-day teenage life. The following characters are instrumental to his struggle: Stiles, his best friend; Allison, his love interest who comes from a family of werewolf hunters; and Derek, a mysterious werewolf with a dark past. Throughout the series, he strives to keep his loved ones safe while maintaining normal relationships with them.", "Teen Wolf" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 66,
                columns: new[] { "Date", "Poster", "Rating", "Summary", "Title" },
                values: new object[] { "2003-09-23", "https://image.tmdb.org/t/p/w300/fi8EvaWtL5CvoielOjjVvTr7ux3.jpg", 7, "From murder and espionage to terrorism and stolen submarines, a team of special agents investigates any crime that has a shred of evidence connected to Navy and Marine Corps personnel, regardless of rank or position.", "NCIS" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 77,
                columns: new[] { "Date", "Poster", "Rating", "Summary", "Title" },
                values: new object[] { "2015-10-26", "https://image.tmdb.org/t/p/w300/zsaiq8ZclPuneuN7loLEbsh1ANJ.jpg", 7, "Twenty-four-year-old Kara Zor-El, who was taken in by the Danvers family when she was 13 after being sent away from Krypton, must learn to embrace her powers after previously hiding them. The Danvers teach her to be careful with her powers, until she has to reveal them during an unexpected disaster, setting her on her journey of heroism.", "Supergirl" });
