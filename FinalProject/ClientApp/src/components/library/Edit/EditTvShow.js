...
export default function EditTvShow(props) {
    ...
    const submit = () => {
        axios.put(`https://localhost:5001/api/tvshows/${props.location.state.id}`, {
            title: title,
            date: date,
            summary: summary,
            rating: rating,
        ...
        <div className="fade-me">
            ...
            >
                <div className="mb-3">
                    ...
                    <input
                        type="text"
                        defaultValue={tvShow? tvShow.title : "" || ""}
                ...
                <div className="mb-3">
                    ...
                    <input
                        type="date"
                        defaultValue={tvShow? tvShow.date : "" || ""}
                        className="form-control"
                        id="date"
                ...
                <div className="mb-3">
                    ...
                    <textarea
                        rows="3"
                        defaultValue={tvShow? tvShow.summary : "" || ""}
                        className="form-control"
                        id="summary"
                ...
                <div className="mb-3">
                    ...
                    <input
                        type="number"
                        className="form-control"
                        defaultValue={tvShow? tvShow.rating : "" || ""}
                        id="rating"
                        min="1"
                        max="10"
                ...
                <div className="mb-3">
                    ...
                    <input
                        type="text"
                        defaultValue={tvShow? tvShow.poster : "" || ""}
                        className="form-control"
                        id="poster"
