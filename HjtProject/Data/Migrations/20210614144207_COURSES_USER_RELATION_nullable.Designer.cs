...
namespace HjtProject.Data.Migrations
{
    ...
    [Migration("20210614144207_COURSES_USER_RELATION_nullable")]
    partial class COURSES_USER_RELATION_nullable
    {
            ...
            modelBuilder.Entity("HjtProject.Models.UserProfileModel", b =>
                {
                    ...
                    b.Property<int?>("InstructorModelId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HjtProject.Models.UserProfileModel", b =>
                {
                    ...
                    b.HasOne("HjtProject.Models.InstructorModel", null)
                        .WithMany("UserProfiles")
                        .HasForeignKey("InstructorModelId");
