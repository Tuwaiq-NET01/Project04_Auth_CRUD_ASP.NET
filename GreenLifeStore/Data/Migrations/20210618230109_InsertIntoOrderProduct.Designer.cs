...
namespace GreenLifeStore.Data.Migrations
{
    ...
    [Migration("20210618230109_InsertIntoOrderProduct")]
    partial class InsertIntoOrderProduct
    {
            ...
            modelBuilder.Entity("GreenLifeStore.Models.OrderModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            OrderId = 1,
                            OrderDate = new DateTime(2021, 6, 19, 2, 1, 8, 434, DateTimeKind.Local).AddTicks(7417),
                            TotalPrice = 236.5f,
                        ...
                        {
                            OrderId = 2,
                            OrderDate = new DateTime(2021, 6, 19, 2, 1, 8, 436, DateTimeKind.Local).AddTicks(750),
                            TotalPrice = 216.5f,
                        ...
                        {
                            OrderId = 3,
                            OrderDate = new DateTime(2021, 6, 19, 2, 1, 8, 436, DateTimeKind.Local).AddTicks(810),
                            TotalPrice = 67f,
