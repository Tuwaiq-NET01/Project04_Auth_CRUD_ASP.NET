...
{
    public class FavoriteMoviesControllerTest
    {
        ...
        public void Setup()
        {
            ...
            controller = new FavoriteMoviesController(context, _jwtService);
        ...
        {
            var result = (UnauthorizedResult) controller.GetFavMovie();
