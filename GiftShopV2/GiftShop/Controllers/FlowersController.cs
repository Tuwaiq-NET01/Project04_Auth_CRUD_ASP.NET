...
namespace GiftShop.Controllers
{
    ...
    public class FlowersController : Controller
    {
        ...
        {
            var Flower = _db.Flowers.ToList().Find(Customer => Customer.FlowerId == id);
        ...
        [HttpPost]
        public IActionResult Edit([Bind("FlowerId", "FlowerImage", "FlowerName", "FlowerPrice")] FlowerModel Flower)
        {
