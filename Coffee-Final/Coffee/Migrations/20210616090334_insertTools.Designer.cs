...
namespace Coffee.Migrations
{
    ...
    [Migration("20210616090334_insertTools")]
    partial class insertTools
    {
            ...
            modelBuilder.Entity("Coffee.Models.Tool", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 6,
                            Description = "Cloth towel made of cloth and silicone,Suitable for cleaning steam wand Made of three layers to protect against high heat",
                        ...
                        {
                            ID = 7,
                            Description = "Suitable for home and professional barista use, you can monitor and control the time and weight via a built-in smart screen.",
