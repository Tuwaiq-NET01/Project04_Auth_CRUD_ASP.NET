...
namespace Coffee.Data
{
    public class AppDbContext : IdentityDbContext
    {
        ...
        modelBuilder.Entity<Roastery>()
         ...
         {
             ID = 4,
             Name = "Tach standard espresso glass",
             Image = "https://cdn.shopify.com/s/files/1/0028/9085/8569/products/Artboard_6_1df5b44a-0936-4182-9f24-cf9f355ebb65_700x.jpg?v=1599732510",
             Description= @"70 Tache Espresso Glass Standard with a capacity of 70ml
             Double flow, smooth design and convenient pour handle
              Marks listed in milliliters and ounces"
         });
            modelBuilder.Entity<Tool>()
         .HasData(new Tool
         {
             ID = 5,
             Name = "Tach thermometer for steaming milk",
             Image = "https://cdn.shopify.com/s/files/1/0028/9085/8569/products/0007__DSC0882_1000x.jpg?v=1611678428",
             Description= @"Made of stainless steel, resistant to high temperatures, silver color
            The temperature is measured in Fahrenheit.
            Compatible with all types of steaming jugs"
         });
             modelBuilder.Entity<Tool>()
         .HasData(new Tool
         {
             ID = 6,
             Name = "TASH Cloth Steamer Wand Cleaning Towel",
             Image = "https://cdn.shopify.com/s/files/1/0028/9085/8569/products/DSC3126_1000x.jpg?v=1611737108",
             Description= @"Cloth towel made of cloth and silicone,Suitable for
                   cleaning steam wand Made of three layers to protect against high heat"
         });
                       modelBuilder.Entity<Tool>()
         .HasData(new Tool
         {
             ID = 7,
             Name = "Taymore white digital scale",
             Image = "https://cdn.shopify.com/s/files/1/0028/9085/8569/products/51b7HH9VVfL._AC_SL1100_1000x.jpg?v=1603869810",
             Description= @"Suitable for home and professional barista use, you can monitor 
             and control the time and weight via a built-in smart screen."
         });
        }
