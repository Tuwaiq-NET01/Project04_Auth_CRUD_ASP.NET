...
namespace Induction.Migrations
{
    ...
    [Migration("20210619164017_initialCreate")]
            ...
            modelBuilder.Entity("Induction.Models.ChapterChunkModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ChapterId = 2,
                            CreatedAt = new DateTime(2021, 6, 19, 16, 40, 16, 680, DateTimeKind.Utc).AddTicks(154),
                            CurrentPage = 23,
                            Title = "Deep Coding"
                        },
                        new
                        {
                            ...
                            Body = "a small intro ",
                            ChapterId = 1,
                            CreatedAt = new DateTime(2021, 6, 19, 16, 40, 16, 680, DateTimeKind.Utc).AddTicks(956),
                            CurrentPage = 12,
                            Title = "intro"
                        });
                });
            ...
            modelBuilder.Entity("Induction.Models.FactModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Body = "C# is OOP",
                            CreatedAt = new DateTime(2021, 6, 19, 16, 40, 16, 679, DateTimeKind.Utc).AddTicks(1576),
                            UserId = 2
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 6, 19, 16, 40, 16, 679, DateTimeKind.Utc).AddTicks(2378),
                            UserId = 1
                        });
                });
            ...
            modelBuilder.Entity("Induction.Models.MotivationModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 6, 19, 16, 40, 16, 678, DateTimeKind.Utc).AddTicks(9179),
                            UserId = 2
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 6, 19, 16, 40, 16, 679, DateTimeKind.Utc).AddTicks(74),
                            UserId = 1
                        });
                });
